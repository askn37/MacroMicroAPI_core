...
#define EEPROM  __attribute__((__used__,section(".eeprom")))
#define USERSIG __attribute__((__used__,section(".user_signatures")))
#define BOOTSIG __attribute__((__used__,section(".boot_signatures")))
